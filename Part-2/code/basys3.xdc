...
#set_property PACKAGE_PIN U4 [get_ports {Ca[7]}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {Ca[7]}]
#set_property PACKAGE_PIN V4 [get_ports {Ca[8]}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {Ca[8]}]
#set_property PACKAGE_PIN W4 [get_ports {Ca[9]}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {Ca[9]}]
